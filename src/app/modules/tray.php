    ...
    public function showtray($MainForm ,  $contextMenu , $updateModule , $icopack) {
        ...
        *///Событие при нажатие
        ...
        //-------------------------------------------------------------------------------
            $this->contextMenu->items->add(UXMenuItem::createSeparator());//Создаем сеппаратор
        ///-------------------------------------------------------------------------------
        $menuStore = new UXMenuItem('Открыть Магазин' , new UXImageView (new UXImage('ico' . fs::separator() . 'tray' . fs::separator() . $icopack->getTray() . fs::separator() . 'store.png')));//Создаем item + иконка
        //Событие при нажатие
        ...
        //Событие при нажатие
        $menuSettings = new UXMenuItem('Открыть настройки' , new UXImageView (new UXImage('ico' . fs::separator() . 'tray' . fs::separator() . $icopack->getTray() . fs::separator() . 'settings.png')));//Создаем item + иконка
        //Событие при нажатие
        ...
        $menuchat = new UXMenuItem('Открыть чат' , new UXImageView (new UXImage('ico' . fs::separator() . 'tray' . fs::separator() . $icopack->getTray() . fs::separator() . 'chat.png')));//Создаем item + иконка
        //Событие при нажатие
